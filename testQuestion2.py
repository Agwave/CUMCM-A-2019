...
def tes_ques2(angular_velocity, dt=0.01, iteration_time=50000):
    t_to_draw = []
    p_tube_to_draw = []
...
def draw_curve(t_to_draw, p_b_to_draw):
    ...
    plt.title("angularvelocity: 0.020339965820312503ms")
    plt.xlabel("time")
    plt.ylabel("pressure")
    plt.xlim(0, 1000)
    plt.ylim(0,150)
...
if __name__ == "__main__":
    tes_ques2(angular_velocity=0.020339965820312503, dt=0.0001, iteration_time=1000)
